...
const Hero = () => {
  const highlightItems = [
    {
      title: "2+ Years",
      desc: "Professional Full-Stack Development",
    },
    {
      title: "4× Awards",
      desc: "Cisco IT Challenge Coin",
    },
    {
      title: "1000+ Users",
      desc: "Placement & Alumni Portal",
    },
    {
  ...
  return (
    <div className="pb-20 pt-36 relative overflow-hidden w-full">
      ...
      <div className="relative flex flex-col items-center lg:items-start justify-center my-20 z-10 w-full">
        ...
        {/* Quick Highlights (with hover card effect) */}
        ...
        <div className="mt-16 w-full flex flex-col items-center relative">
          ...
          <div className="max-w-6xl p-8 bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 shadow-lg flex flex-col items-center">
            ...
            {/* Categories with subtle vertical dividers on large screens */}
            <div className="flex flex-wrap justify-center w-full divide-x divide-white/10">
              {/* Frontend */}
              <div className="flex flex-col items-center px-6 py-2 w-full lg:w-1/4">
                  ...
                  {[
                    ...
                    return (
                      <div key={tech.name} className="flex flex-col items-center group">
                        <Icon className={`w-12 h-12 ${tech.color} group-hover:scale-125 transition-transform duration-300`} title={tech.name} />
                        <span className="text-sm mt-1 opacity-80 text-white">{tech.name}</span>
                      </div>
                    );
                  })}
                </div>
              ...
              <div className="flex flex-col items-center px-6 py-2 w-full lg:w-1/4">
                ...
                <div className="flex flex-wrap justify-center gap-6">
                  {[
                    ...
                    // add more backend languages/tools as needed
                  ].map((tech) => {
                    const Icon = tech.icon;
                    return (
                      <div key={tech.name} className="flex flex-col items-center group">
              ...
              {/* Cloud */}
              <div className="flex flex-col items-center px-6 py-2 w-full lg:w-1/4">
                <h3 className="text-xl font-semibold mb-4 text-white">Cloud</h3>
                <div className="flex flex-wrap justify-center gap-6">
                  {[
              ...
              {/* DevOps & Databases */}
              <div className="flex flex-col items-center px-6 py-2 w-full lg:w-1/4">
                <h3 className="text-xl font-semibold mb-4 text-white">DevOps & Databases</h3>
                <div className="flex flex-wrap justify-center gap-6">
                  {[
        ...
        <div className="flex flex-col items-center mt-10 space-y-3 w-full">
          <p className="text-sm uppercase tracking-wide opacity-70">Reach me at</p>
          <div className="flex space-x-6">
            <a href="https://github.com/yashasuttangi" target="_blank" rel="noopener noreferrer">
              <FaGithub className="w-6 h-6 hover:text-purple-400 transition-colors" />
            </a>
            <a href="https://www.linkedin.com/in/yashas-uttangi-332898191/" target="_blank" rel="noopener noreferrer">
